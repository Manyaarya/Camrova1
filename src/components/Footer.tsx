        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div>
            <Link href="/" className="flex items-center gap-2 group">
              <div className="w-10 h-10 rounded-full bg-gold/10 flex items-center justify-center border border-gold/30 group-hover:border-gold/60 transition-colors">
                <svg
                  viewBox="0 0 24 24"
                  fill="none"
                  stroke="currentColor"
            ...
            <p className="mt-4 text-foreground/60 text-sm">
              Book a Lens. Build a Brand.
            </p>
            <p className="mt-2 text-foreground/40 text-sm">
              Delhi&apos;s photographers on demand.
            </p>
          </div>
